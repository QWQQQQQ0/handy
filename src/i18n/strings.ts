...
const translations: Record<string, Record<string, string>> = {
  ...
  'nav.apps': { en: 'Projects', zh: '项目' },
  'projects.title': { en: 'Projects', zh: '项目' },
  'projects.import': { en: 'Import Folder', zh: '导入文件夹' },
  'projects.importDesc': { en: 'Enter the folder path to import', zh: '输入要导入的文件夹路径' },
  'projects.folderPath': { en: 'Folder path', zh: '文件夹路径' },
  'projects.importConfirm': { en: 'Import', zh: '导入' },
  'projects.active': { en: 'Active', zh: '已激活' },
  'projects.sourceGenerated': { en: 'Generated', zh: '生成' },
  'projects.sourceImported': { en: 'Imported', zh: '导入' },
  'projects.noProjects': { en: 'No projects yet', zh: '暂无项目' },
  'projects.createFirst': { en: 'Create your first project', zh: '创建第一个项目' },
  'projects.newProject': { en: 'New Project', zh: '新建项目' },
  'projects.projectName': { en: 'Project name', zh: '项目名称' },
  'nav.desktop': { en: 'Desktop', zh: '桌面' },
  'nav.settings': { en: 'Settings', zh: '设置' },
  'nav.scheduledTasks': { en: 'Tasks', zh: '后台任务' },
